...
object Constants {
    ...
    const val WORKER_INPUT_SOURCE = "WORKER_INPUT_SOURCE"
    const val WORKER_INPUT_SENDER_LOGOUT = "WORKER_INPUT_SENDER_LOGOUT"
    const val WORKER_INPUT_SENDER_PERIODIC = "WORKER_INPUT_SENDER_PERIODIC"
